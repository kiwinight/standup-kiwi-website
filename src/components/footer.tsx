import { Container, Flex, Grid, Link, Section, Text } from "@radix-ui/themes";
          ...
          >
            ...
            <Flex direction="column" gap="3">
              ...
              <Text size="2" color="gray">
                A project by{" "}
                <Flex display="inline-flex" asChild align="center" gap="1">
              ...
              <Flex direction="column" gap="2">
                <Text size="2" color="gray">
                  <Flex asChild align="center" gap="1">
                    <Link
                      href="https://www.linkedin.com/company/standup-kiwi"
                      target="_blank"
                    >
                      LinkedIn
                      <ExternalLinkIcon />
